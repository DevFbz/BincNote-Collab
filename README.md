...
`BincNote-Collab` is a project that aims to support the collaborative features of BincNote. It consists of several crates that are currently under active development:
...
abstraction for the collaborative features of BincNote. It offers a simple API for creating and managing collaborative
documents.

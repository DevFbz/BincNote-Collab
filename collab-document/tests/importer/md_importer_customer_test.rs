...
#[test]
fn test_customer_bincnote_editor_built_in_readme() {
  let markdown = r#"
## 👋 **Welcome to** ***[BincNote Editor](bincnote.io)***

BincNote Editor is a **highly customizable** _rich-text editor_
...
You can also use ***BincNote Editor*** as a component to build your own app.
...
"#;
  ...
  assert_eq!(
    ...
    r#"[{"insert":"👋 "},{"attributes":{"bold":true},"insert":"Welcome to"},{"insert":" "},{"attributes":{"bold":true,"href":"bincnote.io","italic":true},"insert":"BincNote Editor"}]"#
  );
  ...
  assert_eq!(
    ...
    r#"[{"insert":"BincNote Editor is a "},{"attributes":{"bold":true},"insert":"highly customizable"},{"insert":" "},{"attributes":{"italic":true},"insert":"rich-text editor"}]"#
  );
  ...
  assert_eq!(
    ...
    r#"[{"insert":"You can also use "},{"attributes":{"bold":true,"italic":true},"insert":"BincNote Editor"},{"insert":" as a component to build your own app."}]"#
  );
